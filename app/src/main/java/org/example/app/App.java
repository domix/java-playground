...
public class App {
    public static void main(String[] args) throws IOException {
        ...
        new Button("Add!", () -> updateOutput(txtNum1, txtNum2, lblOutput))
                .addTo(panel);
        ...
        txtNum1.setTextChangeListener((newText, changedByUserInteraction) -> {
            if (changedByUserInteraction) {
                updateOutput(txtNum1, txtNum2, lblOutput);
            }
        });

        txtNum2.setTextChangeListener((newText, changedByUserInteraction) -> {
            if (changedByUserInteraction) {
                updateOutput(txtNum1, txtNum2, lblOutput);
            }
        });
    ...
    private static void updateOutput(TextBox txtNum1, TextBox txtNum2, Label lblOutput) {
